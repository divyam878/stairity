...
const WhatsAppChat = () => {
  ...
  const phoneNumber = "918233120760"; // Replace with your actual WhatsApp number
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 bg-indigo-600/30 backdrop-blur-md hover:bg-indigo-600/40 text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-110 flex items-center justify-center group border border-indigo-400/30"
