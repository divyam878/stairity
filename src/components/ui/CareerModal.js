...
import { X, Loader2, Send, CheckCircle, Briefcase } from "lucide-react";
    ...
    try {
      const res = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          service: `Career Application: ${formData.jobRole}`,
          message: `Portfolio: ${formData.portfolioLink}\n\n${formData.message}`,
        }),
      });
        ...
        <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
          ...
          <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between rounded-t-3xl">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-black">Join Our Team</h2>
            </div>
            <button
              onClick={onClose}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Share your experience, why you want to join us..."
                    rows={4}
